...
<template>
  <div class="w-full max-w-100">
    ...
    <div class="space-y-4 mt-8">
      ...
      <!-- Display Name -->
      <div class="mb-3.5">
        <label class="block text-[12.5px] font-semibold text-neutral-700 mb-1.5"
          >Display name</label
        >
        <input
          ...
          :class="errors.display_name ? 'border-red-500' : 'border-neutral-200'"
        />
      ...
      <button
        ...
        class="w-full bg-primary-800 text-white py-3 rounded-xl hover:cursor-pointer"
      >
        Create Account
      </button>
